    ...
    <section id="about" className="min-h-screen bg-black py-20 page-section">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.div className="space-y-8" variants={itemVariants}>
            <motion.div className="bg-white/5 p-6 border border-white/10" variants={itemVariants}>
              <h3 className="font-retro text-2xl mb-4">SKILLS</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="mb-4">
                  <p className="font-pixel mb-2">HTML</p>
                ...
                <div className="mb-4">
                  <p className="font-pixel mb-2">CSS</p>
                  <div className="h-2 bg-white/20">
                    <motion.div 
                      className="h-full bg-white" 
                      initial={{ width: 0 }}
                ...
                <div className="mb-4">
                  <p className="font-pixel mb-2">JAVASCRIPT</p>
                  <div className="h-2 bg-white/20">
                    <motion.div 
                      className="h-full bg-white" 
                      initial={{ width: 0 }}
                ...
                <div className="mb-4">
                  <p className="font-pixel mb-2">REACT</p>
                  <div className="h-2 bg-white/20">
                    <motion.div 
                      className="h-full bg-white" 
                      initial={{ width: 0 }}
                ...
                <div className="mb-4">
                  <p className="font-pixel mb-2">PROTOTIPAGEM</p>
                  <div className="h-2 bg-white/20">
                    <motion.div 
                      className="h-full bg-white" 
                      initial={{ width: 0 }}
                ...
                <div className="mb-4">
                  <p className="font-pixel mb-2">BANCO DE DADOS</p>
                  <div className="h-2 bg-white/20">
                    <motion.div 
                      className="h-full bg-white" 
                      initial={{ width: 0 }}
